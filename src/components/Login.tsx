      ...
      >
        ...
        >
          ...
          <motion.div variants={formFieldVariants}>
            <Magnetic className="login-magnetic-wrap" strength={0.24}>
              <motion.button
                type="submit"
                className={`signin-button ls-magnetic-glow${isLoading ? ' loading' : ''}`}
                disabled={isLoading}
              ...
              >
                {isLoading ? (
                  <>
                    <span className="ls-neural-loader" aria-hidden="true" />
          ...
          <motion.div className="social-login" variants={formFieldVariants}>
            <Magnetic className="login-magnetic-wrap" strength={0.2}>
              <motion.button
                type="button"
                className={`social-button google-button ls-magnetic-glow${isLoading ? ' loading' : ''}`}
