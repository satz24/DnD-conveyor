...
setTimeout(() => {
  ...
  if (root && root.children.length === 0) {
    root.innerHTML = `
      <div style="min-height: 100vh; display: flex; align-items: center; justify-content: center; background: #0a0a1a; color: #fff; font-family: 'Syne Mono', ui-monospace, monospace;">
        <div style="text-align: center; padding: 40px;">
          <img src="${publicAsset('logo.jpg')}" alt="LinguoSign" style="width: 96px; height: 96px; border-radius: 50%; object-fit: cover; box-shadow: 0 0 32px rgba(56,189,248,0.35); margin-bottom: 18px;" />
